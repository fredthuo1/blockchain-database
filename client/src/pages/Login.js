...
const Login = () => {
    ...
    const { login } = useContext(AuthContext); // Assuming login is a function in your AuthContext to set authentication status
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setErrorMessage(error.response.data.msg); // Display the error message using state instead of an alert
        }
    }
